...
import { clearRecoveryGuard } from './utils/staleChunkRecovery';
...
function App() {
  // Production Stale Chunk Auto-Recovery — clears the one-reload guard
  // once this app instance has actually mounted, so a later, separate
  // deployment can still trigger its own one-time auto-recovery instead
  // of being silently blocked forever by a guard set during a past visit.
  useEffect(() => {
    clearRecoveryGuard();
  }, []);
