      ...
      <div className="container-custom py-8 md:py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          <div className="flex-shrink-0">
            ...
            <p className="text-xs max-w-[220px] leading-relaxed" style={{ color: 'rgba(255,255,255,0.32)' }}>
              Authentic Philippine sports merchandise for fans who live and breathe the game.
            </p>
          </div>
          ...
          <div className="flex gap-12 md:gap-16">
            <div>
              <h4 className="text-xs font-semibold uppercase mb-3" style={{ color: 'rgba(255,255,255,0.35)', letterSpacing: '0.09em' }}>Shop</h4>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.label}>
                    <Link to={link.href} className="text-xs transition-colors" style={{ color: 'rgba(255,255,255,0.45)' }}
            ...
            <div>
              <h4 className="text-xs font-semibold uppercase mb-3" style={{ color: 'rgba(255,255,255,0.35)', letterSpacing: '0.09em' }}>Legal</h4>
              <ul className="space-y-2">
                {[
          ...
          <div className="flex gap-3">
            ...
            <a
              href="https://www.instagram.com/pusopilipinas/"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mt-8 pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <span className="text-xs" style={{ color: 'rgba(255,255,255,0.25)' }}>
            Maya · GCash · Visa · Mastercard · JCB · Amex
          </span>
        </div>
      </div>
    </footer>
