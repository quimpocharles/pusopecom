    ...
    <Layout>
      ...
      <div className="container-custom py-8">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          {event.onSale && (
            <div>
              {/* Running total/checkout for picks made here live in the Cart
                  drawer's Passes tab — not duplicated on this page; steppers
                  below are the only control needed, same as
                  ProductDetail.jsx's own Add-to-Cart-then-check-the-header-
                  icon pattern. The button here just opens that same drawer
                  directly, for anyone who'd rather not reach for the header
                  icon after each pick. */}
              <div className="flex items-center justify-between gap-4 mb-4">
                <p className="text-sm text-gray-500">Pick your section — added passes show up in your cart, top right.</p>
                <button
                  type="button"
                  onClick={() => useCartStore.getState().openCart('passes')}
